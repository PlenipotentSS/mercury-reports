...
const _imports_0 = "" + new URL("electron-7cFhHP7q.svg", import.meta.url).href;
...
const _hoisted_1 = /* @__PURE__ */ createStaticVNode('<img alt="logo" class="logo" src="' + _imports_0 + '"><div class="creator">Powered by electron-vite</div><div class="text"> Build an Electron app with <span class="vue">Vue</span> and <span class="ts">TypeScript</span></div><p class="tip">Please try pressing <code>F12</code> to open the devTool</p>', 4);
const _hoisted_5 = /* @__PURE__ */ createBaseVNode("div", { class: "action" }, [
